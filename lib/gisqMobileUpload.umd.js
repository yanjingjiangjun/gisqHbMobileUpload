...
module.exports = __webpack_require__.p + "static/img/iconfont.eaf79b15.svg";
...
var component = normalizeComponent(
  ...
  sheetvue_type_template_id_ffbe410c_render,
  sheetvue_type_template_id_ffbe410c_staticRenderFns,
  false,
  null,
  null,
  null
...
var dialog_component = normalizeComponent(
  ...
  dialogvue_type_template_id_6431b61c_render,
  dialogvue_type_template_id_6431b61c_staticRenderFns,
  false,
  null,
  null,
  null
  ...
  methods: {
    ...
    takePhoto: function takePhoto() {
      ...
      if (_self.isHbuilder == true) {
        var main = plus.android.runtimeMainActivity();
        var IntentA = plus.android.importClass("android.content.Intent");
        alert(IntentA); //var cameraActivity = plus.android.importClass("com.zjzs.gisq.jetpack.aar_camara.CamaraActivity"); //自己写的二维码扫描页面
        //alert(cameraActivity)
        //var intent = new Intent(main, cameraActivity.class);
        //intent.setClassName(main, cameraActivity.class);

        var intent = new IntentA();
        alert(0); //intent.setPackage("com.zjzs.gisq.qcjg");
